...
android {
    namespace = "com.example.a26_04_ambientit_kotlin"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.example.a26_04_ambientit_kotlin"
        minSdk = 30
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //Coil ImageLoader (OkHttp = TLS natif Android, évite les erreurs handshake du moteur Ktor CIO)
